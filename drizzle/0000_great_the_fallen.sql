...
CREATE TYPE "public"."support_kind" AS ENUM('itemProperty', 'itemType', 'itemEntry', 'itemTypeAdditionalEntries', 'legendaryGroup', 'monsterTemplate', 'monsterFeature');--> statement-breakpoint
...
CREATE TABLE "entity_links" (
	...
	CONSTRAINT "entity_links_from_uid_to_uid_tag_type_pk" PRIMARY KEY("from_uid","to_uid","tag_type")
);
--> statement-breakpoint
...
ALTER TABLE "entity_links" ADD CONSTRAINT "entity_links_from_uid_entities_uid_fk" FOREIGN KEY ("from_uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "entity_links" ADD CONSTRAINT "entity_links_to_uid_entities_uid_fk" FOREIGN KEY ("to_uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "search_index" ADD CONSTRAINT "search_index_uid_entities_uid_fk" FOREIGN KEY ("uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "backgrounds" ADD CONSTRAINT "backgrounds_uid_entities_uid_fk" FOREIGN KEY ("uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "class_features" ADD CONSTRAINT "class_features_uid_entities_uid_fk" FOREIGN KEY ("uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "classes" ADD CONSTRAINT "classes_uid_entities_uid_fk" FOREIGN KEY ("uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "feats" ADD CONSTRAINT "feats_uid_entities_uid_fk" FOREIGN KEY ("uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "generic_entities" ADD CONSTRAINT "generic_entities_uid_entities_uid_fk" FOREIGN KEY ("uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "items" ADD CONSTRAINT "items_uid_entities_uid_fk" FOREIGN KEY ("uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "monsters" ADD CONSTRAINT "monsters_uid_entities_uid_fk" FOREIGN KEY ("uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "optional_features" ADD CONSTRAINT "optional_features_uid_entities_uid_fk" FOREIGN KEY ("uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "races" ADD CONSTRAINT "races_uid_entities_uid_fk" FOREIGN KEY ("uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "spells" ADD CONSTRAINT "spells_uid_entities_uid_fk" FOREIGN KEY ("uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "subclasses" ADD CONSTRAINT "subclasses_uid_entities_uid_fk" FOREIGN KEY ("uid") REFERENCES "public"."entities"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "entity_links_to_uid_index" ON "entity_links" USING btree ("to_uid");--> statement-breakpoint
...
CREATE INDEX "class_features_class_uid_level_index" ON "class_features" USING btree ("class_uid","level");--> statement-breakpoint
CREATE INDEX "class_features_subclass_uid_level_index" ON "class_features" USING btree ("subclass_uid","level");--> statement-breakpoint
...
CREATE INDEX "races_parent_race_uid_index" ON "races" USING btree ("parent_race_uid");--> statement-breakpoint
...
CREATE INDEX "subclasses_class_uid_index" ON "subclasses" USING btree ("class_uid");--> statement-breakpoint
